...
$sqlList = "select distinct(metric) from perfdata where host='{$_GET['host']}' and topic='DISKXFER' and ". $begstr . $endstr . " order by metric";
$disks = array();
...
<div style="margin:15px auto 10px auto;">
  <form name="input" action="diskxfer.php" method="get">
