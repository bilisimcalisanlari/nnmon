...
$sqlEnt = "select distinct(metric) from perfdata where host='{$_GET['host']}' and topic='NET' and metric like '%-read-KB/s' and ". $begstr . $endstr . " order by metric";
$ents = array();
...
<div style="margin:15px auto 10px auto;">
  <form name="input" action="network.php" method="get">
