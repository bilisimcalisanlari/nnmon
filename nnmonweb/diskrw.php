...
$sqlList = "select distinct(metric) from perfdata where host='{$_GET['host']}' and topic='DISKREAD' and ". $begstr . $endstr . " order by metric";
$disks = array();
...
<div style="margin:15px auto 10px auto;">
  <form name="input" action="diskrw.php" method="get">
